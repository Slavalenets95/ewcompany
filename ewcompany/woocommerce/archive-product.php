	...
	if( have_rows('constructor', get_queried_object()) ) :
		while( have_rows('constructor', get_queried_object()) ) : the_row();
			if( get_row_layout() == 'intro_slider') :
				get_template_part('templates/intro_slider/intro_slider');
			endif;
		endwhile;
	endif;
?>
...
if( have_rows('constructor', get_queried_object()) ) :
	while( have_rows('constructor', get_queried_object()) ) : the_row();
		if( get_row_layout() == 'category_description') :
			get_template_part('templates/category_description/category_description');
		endif;
	endwhile;
endif;
...
?>
<div class="container archive-product__container">
